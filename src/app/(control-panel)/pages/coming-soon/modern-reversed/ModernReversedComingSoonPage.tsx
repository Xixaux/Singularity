			...
			<Paper className="flex min-h-full w-full overflow-hidden rounded-none sm:min-h-auto sm:w-auto sm:rounded-xl sm:shadow-sm md:w-full md:max-w-6xl">
				...
				>
					...
					<div className="relative z-10 w-full max-w-4xl">
						...
						<div className="mt-6 text-lg leading-6 tracking-tight text-gray-400">
							Singularity helps developers to build organized and well coded dashboards full of beautiful and
							rich modules. Start creating your application seamlessly today.
						</div>
				...
				<div className="w-full px-4 py-8 ltr:border-l-1 rtl:border-r-1 sm:w-auto sm:p-12 md:p-16">
					<div className="mx-auto w-full max-w-80 sm:mx-0 sm:w-80">
						...
						Want to stay in the loop? Sign up below to get notified about our upcoming launch.
						</Typography>

						<div className="flex flex-col items-center py-12">
							<SingularityCountdown endDate="2071-07-28" />
						</div>
						...
						>
							...
							>
							This isn't a newsletter sign-up. You'll receive a single email when we launch, and then we'll remove you from the list.
