...
type MinimalistPricingCardProps = MinimalistPricingItemType & {
	className?: string;
};

/**
 * The minimalist pricing card component.
 */
function MinimalistPricingCard(props: MinimalistPricingCardProps) {
	const {
		period = '',
		title = '',
		yearlyPrice = '',
...
export default MinimalistPricingCard;
