...
/**
 * The split screen sign out page.
 */
function SplitScreenSignOutPage() {
  ...
  return (
    <div className="flex min-w-0 flex-auto flex-col items-center sm:flex-row sm:justify-center md:items-start md:justify-start">
      <Paper className="flex h-full w-full items-center px-4 py-2 ltr:border-r-1 rtl:border-l-1 sm:h-auto sm:w-auto sm:rounded-xl sm:p-12 sm:shadow-sm md:flex md:h-full md:w-1/2 md:items-center md:justify-end md:rounded-none md:p-16 md:shadow-none">
        <div className="mx-auto w-full max-w-80 sm:mx-0 sm:w-80">
          <img className="mx-auto w-12" src="/assets/images/logo/logo.svg" alt="logo" />
          ...
          <Typography className="mt-8 text-center text-md font-medium" color="text.secondary">
            <span>Go to</span>
