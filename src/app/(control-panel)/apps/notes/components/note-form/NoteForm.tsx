...
function NoteForm(props: NoteFormProps) {
	...
	return (
		<div className="flex flex-col w-full">
			<SingularityScrollbars className="flex flex-auto w-full max-h-160">
							...
							return (
								<div className="relative">
									...
									<Fab
										...
										onClick={() => onChange('')}
									>
										<SingularitySvgIcon size={20}>heroicons-outline:trash</SingularitySvgIcon>
									</Fab>
								</div>
							);
						}}
				...
				<div className="flex items-center space-x-1">
					...
					>
						<IconButton
							...
							size="small"
						>
							<SingularitySvgIcon>heroicons-outline:pencil-square</SingularitySvgIcon>
						</IconButton>
					</Tooltip>
