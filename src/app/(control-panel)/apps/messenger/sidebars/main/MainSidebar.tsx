                ...
                {useMemo(
                    () => (
                        <Paper className="flex p-1 items-center w-full px-2 py-1 border-1 rounded-lg h-9 shadow-none">
                            <SingularitySvgIcon color="action">heroicons-solid:magnifying-glass</SingularitySvgIcon>
                            <Input
                ...
                <List className="w-full">
                    {useMemo(() => {
                        ...
                        function getFilteredArray<T>(arr: T[], _searchText: string): T[] {
                            ...
                            return SingularityUtils.filterArrayByString(arr, _searchText);
                        }
                        ...
                        return (
                            ...
                            >
                                ...
                                {filteredContacts.slice(0, 6).map((contact, index) => (
                                    <motion.div
                                        variants={item}
                                        key={contact.id}
                                    >
                                        <div className={clsx(filteredContacts.slice(0, 5).length !== index + 1 && 'border-b-1')}>
