...
const StyledMessageRow = styled('div')(({ theme }) => ({
  '&.contact': {
    '& .bubble': {
      ...
      color: theme.vars.palette.primary.contrastText, // Changed from secondary.contrastText
      ...
      >
        <Toolbar className="flex items-center justify-between px-4 w-full">
          <div className="flex items-center">
            ...
            >
              <SingularitySvgIcon>heroicons-outline:chat-bubble-left-right</SingularitySvgIcon>
            </IconButton>
            <div
          ...
          <ChatMoreMenu className="-mx-2" contactId={contactId} />
        </Toolbar>
      </Box>
          ...
          <div ref={chatRef} className="flex flex-1 flex-col overflow-y-auto">
            {messages?.length > 0 && (
              <div className="flex flex-col pt-4 px-4 pb-10">
                {messages.map((item, i) => {
                  // Mock data for demo
                  const reaction = i % 3 === 0 ? '❤️ Liked' : i % 3 === 1 ? '👍 Thumbs Up' : '😊 Smiled';
                  ...
                  return (
                    ...
                    >
                      <div
                        className="bubble flex relative items-center justify-center px-3 py-2"
                      ...
                      <Typography
                        className="reaction text-sm mt-0.5"
                        color="text.secondary"
                        sx={{ fontSize: '1rem' }}
                      >
                        {reaction}
            ...
            >
              <div className="flex items-center relative">
                <IconButton type="submit">
                  <SingularitySvgIcon className="text-3xl" color="action">
                ...
                />
                <IconButton type="submit">
                  <SingularitySvgIcon color="action">heroicons-outline:paper-airplane</SingularitySvgIcon>
                </IconButton>
              </div>
            </Paper>
          )}
