			...
			<div className="flex flex-auto flex-col py-4 px-0 sm:px-4">
				<div className="flex flex-col sm:flex-row sm:justify-between justify-center items-center mb-6">
					<div className="mb-4 sm:mb-0 flex items-center">
						...
						<SingularitySvgIcon size={20}>heroicons-outline:chevron-right</SingularitySvgIcon>
				...
				{cardForm.labels && cardForm.labels.length > 0 && (
					<div className="flex-1 mb-6 mx-2">
						<div className="flex items-center mt-4 mb-3">
							<SingularitySvgIcon size={20}>heroicons-outline:tag</SingularitySvgIcon>
				...
				{cardForm.memberIds && cardForm.memberIds.length > 0 && (
					<div className="flex-1 mb-6 mx-2">
						<div className="flex items-center mt-4 mb-3">
							<SingularitySvgIcon size={20}>heroicons-outline:users</SingularitySvgIcon>
				...
				{cardForm.attachments && cardForm.attachments.length > 0 && (
					<div className="mb-6">
						<div className="flex items-center mt-4 mb-3">
							<SingularitySvgIcon size={20}>heroicons-outline:paper-clip</SingularitySvgIcon>
				...
				<div className="mb-6">
					<div className="flex items-center mt-4 mb-3">
						<SingularitySvgIcon size={20}>heroicons-outline:chat-bubble-left-right</SingularitySvgIcon>
							...
							{value.length > 0 && (
								<div className="mb-6">
									<div className="flex items-center mt-4">
										<SingularitySvgIcon size={20}>heroicons-outline:clipboard-document-list</SingularitySvgIcon>
					...
					<div className="flex flex-row items-center sm:items-start sm:flex-col flex-1">
						...
						<Controller
							...
							render={() => (
								...
								>
									<SingularitySvgIcon>heroicons-outline:paper-clip</SingularitySvgIcon>
								</IconButton>
							)}
						/>
