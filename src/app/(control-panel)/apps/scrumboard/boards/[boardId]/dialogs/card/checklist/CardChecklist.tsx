		...
		<div className="mb-6">
			<div className="flex items-center justify-between mt-4 mb-3">
				<div className="flex items-center">
					<SingularitySvgIcon size={20}>heroicons-outline:check-circle</SingularitySvgIcon>
					<Controller
						name="name"
						control={control}
						defaultValue=""
				...
				<div>
					<IconButton
						...
						size="small"
					>
						<SingularitySvgIcon size={20}>heroicons-outline:ellipsis-vertical</SingularitySvgIcon>
					</IconButton>
					<Menu
						id="actions-menu"
						anchorEl={anchorEl}
					...
					>
						...
						<MenuItem onClick={handleOpenNameForm}>
							<ListItemIcon className="min-w-9">
								<SingularitySvgIcon>heroicons-outline:pencil</SingularitySvgIcon>
							</ListItemIcon>
