								...
								<TextField
									...
									slotProps={{
										input: {
											startAdornment: (
												<InputAdornment position="start">
													<SingularitySvgIcon size={20}>heroicons-solid:credit-card</SingularitySvgIcon>
												</InputAdornment>
											)
										}
									}}
								...
								<TextField
									...
									slotProps={{
										input: {
											startAdornment: (
												<InputAdornment position="start">
													<SingularitySvgIcon size={20}>heroicons-solid:lock-closed</SingularitySvgIcon>
												</InputAdornment>
											)
										}
									}}
								...
								<TextField
									...
									slotProps={{
										input: {
											startAdornment: (
												<InputAdornment position="start">
													<SingularitySvgIcon size={20}>heroicons-solid:map</SingularitySvgIcon>
												</InputAdornment>
											)
										}
									}}
								...
								<TextField
									...
									slotProps={{
										input: {
											startAdornment: (
												<InputAdornment position="start">
													<SingularitySvgIcon size={20}>heroicons-solid:hashtag</SingularitySvgIcon>
												</InputAdornment>
											)
										}
									}}
