								...
								<TextField
									...
									slotProps={{
										input: {
											startAdornment: (
												<InputAdornment position="start">
													<SingularitySvgIcon size={20}>heroicons-solid:phone</SingularitySvgIcon>
												</InputAdornment>
											)
										}
									}}
								...
								<TextField
									...
									slotProps={{
										input: {
											startAdornment: (
												<InputAdornment position="start">
													<SingularitySvgIcon size={20}>heroicons-solid:flag</SingularitySvgIcon>
												</InputAdornment>
											)
										}
									}}
								...
								<TextField
									...
									slotProps={{
										input: {
											startAdornment: (
												<InputAdornment position="start">
													<SingularitySvgIcon size={20}>heroicons-solid:globe-alt</SingularitySvgIcon>
												</InputAdornment>
											)
										}
									}}
