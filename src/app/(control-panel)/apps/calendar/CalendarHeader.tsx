      ...
      <div className="flex items-center justify-between space-x-2">
        <div className="flex items-center space-x-2">
          <IconButton
            ...
            size="small"
          >
            <SingularitySvgIcon size={16}>heroicons-outline:bars-3</SingularitySvgIcon>
          </IconButton>
            ...
            <div>
              ...
              >
                <IconButton
                  ...
                  size="small"
                >
                  <SingularitySvgIcon size={16}>heroicons-outline:calendar</SingularitySvgIcon>
                </IconButton>
              </motion.div>
            </div>
          </Tooltip>
