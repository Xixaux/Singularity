		...
		>
			...
			<div className="flex flex-1 justify-end items-center">
				...
				<Tooltip title="Set important">
					...
					>
						<SingularitySvgIcon className={clsx(mail.important && 'text-red-600 dark:text-red-500')}>
				...
				<Tooltip title="Set starred">
					...
					>
						<SingularitySvgIcon className={clsx(mail.starred && 'text-orange-500 dark:text-red-400')}>
