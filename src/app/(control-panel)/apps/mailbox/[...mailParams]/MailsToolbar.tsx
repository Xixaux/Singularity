  ...
  return (
    <div className="sticky top-0 z-10">
      ...
      >
        ...
        >
          <SingularitySvgIcon size={16}>heroicons-outline:chevron-down</SingularitySvgIcon>
        </IconButton>
          ...
          <>
            ...
            <Tooltip title="Move to folder">
              <IconButton
                ...
                size="small"
              >
                <SingularitySvgIcon>heroicons-outline:folder</SingularitySvgIcon>
              </IconButton>
            </Tooltip>
            ...
            <Tooltip title="Add label">
              <IconButton
                ...
                size="small"
              >
                <SingularitySvgIcon>heroicons-outline:tag</SingularitySvgIcon>
              </IconButton>
            </Tooltip>
            ...
            <Tooltip title="Set important">
              <IconButton
                ...
                size="small"
              >
                <SingularitySvgIcon sx={{ color: `${getRandomColor()} `, opacity: 0.6 }}>
