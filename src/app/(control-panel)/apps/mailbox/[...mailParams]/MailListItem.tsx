...
const StyledListItem = styled(ListItemButton)<ListItemButtonProps & SingularityNavLinkPropsType & { unread: number }>(
	({ theme }) => ({
						...
						<div className="flex items-center w-full mt-1">
							...
							{((mail.attachments && mail.attachments.length > 0) || mail.starred) && (
								<div className="flex ml-auto pl-2">
									<SingularitySvgIcon size={16}>heroicons-solid:paper-clip</SingularitySvgIcon>
