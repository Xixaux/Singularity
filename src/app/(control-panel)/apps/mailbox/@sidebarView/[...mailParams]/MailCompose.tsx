...
const defaultValues: FormType = {
	from: { email: 'johndoe@Savvy Stacks.com' },
	to: '',
	cc: [],
	bcc: [],
	subject: '',
	...
	return (
		<div className={clsx('', className)}>
			<Button
				...
				startIcon={<SingularitySvgIcon>heroicons-outline:plus</SingularitySvgIcon>}
			>
				{t('COMPOSE')}
			</Button>
			...
			>
				...
				>
					...
					<DialogActions className="flex flex-col sm:flex-row sm:items-center justify-between py-4 sm:py-6 px-6">
						<div className="-mx-2">
							<IconButton>
								<SingularitySvgIcon size={20}>heroicons-solid:paper-clip</SingularitySvgIcon>
							</IconButton>
							...
							<IconButton>
								<SingularitySvgIcon size={20}>heroicons-outline:face-smile</SingularitySvgIcon>
							</IconButton>

							<IconButton>
								<SingularitySvgIcon size={20}>heroicons-solid:photo</SingularitySvgIcon>
							</IconButton>
						</div>
