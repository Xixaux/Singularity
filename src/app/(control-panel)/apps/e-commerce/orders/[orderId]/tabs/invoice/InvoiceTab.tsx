          ...
          <CardContent className="p-22 print:p-0">
            ...
            <div className="flex justify-between">
              ...
              <div className="seller flex items-center p-4">
                ...
                <div className="px-2">
                  <Typography color="inherit">SINGULARITY INC.</Typography>
                  ...
                  <Typography color="inherit">hello@singularityinc.com</Typography>
                  <Typography color="inherit">www.singularityinc.com</Typography>
                </div>
              </div>
            </div>
