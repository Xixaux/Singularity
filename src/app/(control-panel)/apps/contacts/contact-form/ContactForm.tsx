...
function BirtdayIcon() {
	return <SingularitySvgIcon size={20}>heroicons-solid:cake</SingularitySvgIcon>;
}
...
function ContactForm(props: ContactFormProps) {
	...
	const onSubmit = useCallback(() => {
		// Format form data with correctly transformed fields
		const formData = {
			...form,
	...
	if (_.isEmpty(form)) {
		return <SingularityLoading className="min-h-screen" />;
	}
									...
									<div className="absolute inset-0 flex items-center justify-center z-20">
										<div>
											...
											>
												...
												/>
												<SingularitySvgIcon className="text-white">
										...
										<div>
											...
											>
												<SingularitySvgIcon className="text-white">heroicons-solid:trash</SingularitySvgIcon>
											</IconButton>
										</div>
									</div>
									<Avatar
								...
								input: {
									startAdornment: (
										<InputAdornment position="start">
											<SingularitySvgIcon size={20}>heroicons-solid:user-circle</SingularitySvgIcon>
										</InputAdornment>
									)
								}
							}}
						...
						<TextField
							...
							slotProps={{
								input: {
									startAdornment: (
										<InputAdornment position="start">
											<SingularitySvgIcon size={20}>heroicons-solid:briefcase</SingularitySvgIcon>
										</InputAdornment>
									)
								}
							}}
						...
						<TextField
							...
							slotProps={{
								input: {
									startAdornment: (
										<InputAdornment position="start">
											<SingularitySvgIcon size={20}>heroicons-solid:building-office-2</SingularitySvgIcon>
										</InputAdornment>
									)
								}
							}}
						...
						<TextField
							...
							slotProps={{
								input: {
									startAdornment: (
										<InputAdornment position="start">
											<SingularitySvgIcon size={20}>heroicons-solid:map-pin</SingularitySvgIcon>
										</InputAdornment>
									)
								}
							}}
								...
								input: {
									...
									startAdornment: (
										<InputAdornment
											...
											position="start"
										>
											<SingularitySvgIcon size={20}>heroicons-solid:bars-3-bottom-left</SingularitySvgIcon>
										</InputAdornment>
									)
								}
							}}
