				...
				<div className="w-full max-w-5xl">
					<div className="flex flex-auto items-end -mt-16">
						...
						<div className="flex items-center ml-auto mb-1">
							...
							>
								<SingularitySvgIcon size={20}>heroicons-outline:pencil-square</SingularitySvgIcon>
					...
					<div className="flex flex-col space-y-8">
						{contact.title && (
							<div className="flex items-center">
								<SingularitySvgIcon>heroicons-outline:briefcase</SingularitySvgIcon>
						...
						{contact.company && (
							<div className="flex items-center">
								<SingularitySvgIcon>heroicons-outline:building-office-2</SingularitySvgIcon>
						...
						{contact?.emails?.length && contact.emails.some((item) => item.email?.length > 0) && (
							<div className="flex">
								<SingularitySvgIcon>heroicons-outline:envelope</SingularitySvgIcon>
						...
						{contact?.phoneNumbers &&
							...
							contact.phoneNumbers.some((item) => item.phoneNumber?.length > 0) && (
								<div className="flex">
									<SingularitySvgIcon>heroicons-outline:phone</SingularitySvgIcon>
									<div className="min-w-0 ml-6 space-y-1">
						...
						{contact.address && (
							<div className="flex items-center">
								<SingularitySvgIcon>heroicons-outline:map-pin</SingularitySvgIcon>
						...
						{contact.birthday && (
							<div className="flex items-center">
								<SingularitySvgIcon>heroicons-outline:cake</SingularitySvgIcon>
						...
						{contact.notes && (
							<div className="flex">
								<SingularitySvgIcon>heroicons-outline:bars-3-bottom-left</SingularitySvgIcon>
								<div
