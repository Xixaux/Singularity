...
import { CourseStep, useGetAcademyCourseStepContentQuery } from '../../LearningApi';
...
function CourseStepContent(props: CourseStepContentProps) {
  ...
  return (
    <Paper className="w-full mx-auto sm:my-2 lg:mt-4 p-6 sm:p-10 sm:py-12 rounded-xl shadow-sm overflow-hidden">
      <Typography variant="h4" className="mb-4 font-medium">
        {step?.title}
      </Typography>

      <Typography className="text-2xl mb-8" variant="h5">
        {step?.subtitle}
      </Typography>
