        ...
        <div className="flex flex-col min-h-full w-full relative">
          ...
          {!isMobile && (
            <div className="flex justify-center w-full absolute bottom-0 left-0 right-0 p-4 pb-8 z-10">
              ...
              >
                <Button
                  startIcon={<SingularitySvgIcon>heroicons-outline:arrow-small-left</SingularitySvgIcon>}
                  onClick={handleBack}
                >
                  Prev
                </Button>
                ...
                <Button
                  endIcon={<SingularitySvgIcon>heroicons-outline:arrow-small-right</SingularitySvgIcon>}
                  onClick={handleNext}
                >
                  Next
                </Button>
          ...
          {isMobile && (
            ...
            >
              ...
              <IconButton onClick={handleBack}>
                <SingularitySvgIcon>heroicons-outline:arrow-small-left</SingularitySvgIcon>
              </IconButton>

              <IconButton onClick={handleNext}>
                <SingularitySvgIcon>heroicons-outline:arrow-small-right</SingularitySvgIcon>
              </IconButton>
            </Box>
          )}
        </div>
