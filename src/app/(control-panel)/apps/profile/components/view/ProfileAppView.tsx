'use client';
import SingularityPageSimple from '@singularity/core/SingularityPageSimple';
...
const Root = styled(SingularityPageSimple)(({ theme }) => ({
				...
				<div className="flex w-full flex-col">
					...
					<div className="mx-auto flex w-full max-w-7xl shrink-0 flex-col items-center px-8 lg:h-18 lg:flex-row">
						<div className="-mt-24 rounded-full lg:-mt-22">
							...
							>
								<Avatar
									...
									src="/assets/images/avatars/aaron-madison.jpg"
									alt="User avatar"
								/>
							</motion.div>
						</div>
						...
						<div className="mt-4 flex flex-col items-center lg:mt-0 lg:ml-8 lg:items-start">
							<Typography className="text-lg leading-none font-bold">Aaron Madison</Typography>
							<Typography color="text.secondary">Ontario, CA</Typography>
						</div>
						...
						<div className="mt-3 flex items-center gap-6 lg:mt-0">
							<div className="flex flex-col items-center">
								<Typography className="font-bold">176k</Typography>
								<Typography
							...
							<div className="flex flex-col items-center">
								<Typography className="font-bold">1.8k</Typography>
								<Typography
									className="text-sm font-medium"
									color="text.secondary"
								>
