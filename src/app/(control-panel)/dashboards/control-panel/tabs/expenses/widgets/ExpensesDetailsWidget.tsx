...
import ExpensesDetailsDataType from './types/ExpensesDetailsDataType';

/**
 * The ExpensesDetailsWidget widget.
 */
function ExpensesDetailsWidget() {
    const { data: widgets, isLoading } = useGetControlPanelDashboardWidgetsQuery();
    const widget = widgets?.expensesDetails as ExpensesDetailsDataType;
    ...
    return (
        <Paper className="flex flex-col flex-auto p-6 shadow-sm rounded-xl overflow-hidden">
            <Typography className="text-lg font-medium tracking-tight leading-6 truncate">Expenses Details</Typography>
...
export default memo(ExpensesDetailsWidget);