...
import ExpensesDistributionDataType from './types/ExpensesDistributionDataType';
import { useGetControlPanelDashboardWidgetsQuery } from '../../../ControlPanelDashboardApi';
import dynamic from 'next/dynamic';
const ReactApexChart = dynamic(() => import('react-apexcharts'), { ssr: false });

function ExpensesDistributionWidget() {
    const { data: widgets, isLoading } = useGetControlPanelDashboardWidgetsQuery();
    const widget = widgets?.expensesDistribution as ExpensesDistributionDataType;
...
export default memo(ExpensesDistributionWidget);