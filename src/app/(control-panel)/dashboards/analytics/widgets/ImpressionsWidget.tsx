...
/**
 * Impressions widget with a scatter chart.
 */
function ImpressionsWidget() {
    const theme = useTheme();
    const widget = useAppSelector(selectWidget<ImpressionsWidgetType>('impressions'));
    ...
    const series = widget?.series || [
        {
            name: 'Impressions',
            data: [
                4000, 4100, 4200, 4300, 4250, 4150, 4050, 4100, 4200, 4400,
                4500, 4450, 4350, 4250, 4300, 4200, 4100, 4150, 4250, 4300,
                4400, 4500, 4450, 4350, 4250, 4200, 4150, 4100, 4050, 4080
            ]
        }
    ];
    ...
    const chartOptions: ApexOptions = {
        ...
        tooltip: {
            ...
            y: {
                formatter: (value) => `${value.toLocaleString('en-US')} impressions`
            }
        },
        xaxis: {
            type: 'category',
...
export default ImpressionsWidget;