...
import SingularityComponentsNavigation from './singularity-components/SingularityComponentsNavigation';
...
import singularityReactLatestVersion from './changelog/constants/singularityReactLatestVersion';

/**
 * Documentation Navigation
 */
const DocumentationNavigation: SingularityNavItemType = {
  id: 'documentation',
  title: 'Documentation',
  subtitle: 'Everything you need to know about Singularity',
  ...
  children: [
    {
      ...
      badge: {
        title: singularityReactLatestVersion,
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: 'singularity-react-code-splitting-doc',
        ...
        {
          id: 'singularity-react-multi-language-doc',
        ...
        {
          id: 'updating-singularity-react-doc',
          title: 'Updating Guide',
          type: 'item',
          icon: 'heroicons-outline:chevron-double-up',
          url: '/documentation/development/updating-singularity-react',
        },
        {
          id: 'singularity-react-ides-vscode-webstorm-doc',
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: 'singularity-react-routing-doc',
          title: 'Routing',
          type: 'item',
        ...
        {
          id: 'singularity-react-navigation-doc',
          title: 'Navigation',
          type: 'item',
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              id: 'user-interface.page-layouts.CardLayout',
              title: 'CardLayout',
              type: 'collapse',
              children: [
                {
                  id: 'user-interface.page-layouts.CardLayout.full-width',
                  title: 'Full Width',
                  type: 'collapse',
                  url: '/documentation/user-interface/page-layouts/CardLayout/full-width',
                  children: [
                    {
                      id: 'user-interface.page-layouts.CardLayout.full-width.overview',
                      title: 'Full Width Overview',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/full-width/overview',
                    },
                    {
                      id: 'user-interface.page-layouts.CardLayout.full-width.normal-scroll',
                      title: 'Full Width Normal Scroll',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/full-width/normal-scroll',
                    },
                    {
                      id: 'user-interface.page-layouts.CardLayout.full-width.page-scroll',
                      title: 'Full Width Page Scroll',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/full-width/page-scroll',
                    },
                    {
                      id: 'user-interface.page-layouts.CardLayout.full-width.content-scroll',
                      title: 'Full Width Content Scroll',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/full-width/content-scroll',
                    },
                  ],
                },
                {
                  id: 'user-interface.page-layouts.CardLayout.with-sidebars',
                  title: 'With Sidebars',
                  type: 'collapse',
                  url: '/documentation/user-interface/page-layouts/CardLayout/with-sidebars',
                  children: [
                    {
                      id: 'user-interface.page-layouts.CardLayout.with-sidebars.overview',
                      title: 'With Sidebars Overview',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/with-sidebars/overview',
                    },
                    {
                      id: 'user-interface.page-layouts.CardLayout.with-sidebars.normal-scroll',
                      title: 'With Sidebars Normal Scroll',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/with-sidebars/normal-scroll',
                    },
                    {
                      id: 'user-interface.page-layouts.CardLayout.with-sidebars.page-scroll',
                      title: 'With Sidebars Page Scroll',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/with-sidebars/page-scroll',
                    },
                    {
                      id: 'user-interface.page-layouts.CardLayout.with-sidebars.content-scroll',
                      title: 'With Sidebars Content Scroll',
                      type: 'item',
                      url: '/documentation/user-interface/page-layouts/CardLayout/with-sidebars/content-scroll',
                    },
                  ],
                },
              ],
    ...
    },
    {
      ...
      children: [SingularityComponentsNavigation, MaterialUIComponentsNavigation, ThirdPartyComponentsNavigation],
    },
  ],
};
