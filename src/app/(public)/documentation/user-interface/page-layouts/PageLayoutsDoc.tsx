	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				One of the strong sides of the Singularity React is its Page layout components.
			</Typography>
			<Typography
				className="mb-4"
				component="p"
			>
				Every single app, pre-built pages uses the Singularity React's page layout components.
			</Typography>
			<Typography
				className="mb-4"
				component="p"
			...
			<Typography
				...
				component="p"
			>
				Because page layout components, it's very easy to replicate any page style that you can find in Singularity
				React.
			</Typography>
			...
			>
				<ul>
					<li className="mb-2">
						<Link to="/documentation/singularity-components/singularity-page-simple">SingularitySimpleLayout</Link>
					</li>
					<li className="mb-2">
						<Link to="/documentation/singularity-components/singularity-page-CardLayout">SingularityPageCardLayout</Link>
					</li>
				</ul>
			</Typography>
		</>
