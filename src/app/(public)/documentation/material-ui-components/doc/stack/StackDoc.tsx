...
import CollapsedStackComponent from '../../components/stack/CollapsedStack';
import CollapsedStackRaw from '../../components/stack/CollapsedStack.tsx?raw';
...
`}
			...
			>
				<SingularityExample
					name="CollapsedStack.js"
					className="my-4"
					iframe={false}
					component={CollapsedStackComponent}
					raw={CollapsedStackRaw}
				/>
			</Typography>
			<Typography
				className="text-3xl mt-6 mb-2.5 font-bold"
