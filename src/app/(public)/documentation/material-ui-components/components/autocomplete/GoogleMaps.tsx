...
// For this demo, we use debounce to minimize Google Maps Places API quota usage
// However, prefer using throttle in practice
// import throttle from 'lodash/throttle';
import { debounce } from '@mui/material/utils';

// This key was created specifically for the mui.com demo.
// You must create a new key for your application.
const GOOGLE_MAPS_API_KEY = 'AIzaSyDD9RwGjJpKBs5eCGNR8ZNDUP2gtLXWXQw';
...
export default function GoogleMaps() {
  ...
  useEnhancedEffect(() => {
    ...
    // Enable resolution of out-of-order request handling.
    let active = true;
...
// Mock data in case the Google Maps Places API hits a rate limit.
const fakeAnswer = {
  p: [
    {
