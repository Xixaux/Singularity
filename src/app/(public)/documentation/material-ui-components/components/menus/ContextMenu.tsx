  ...
  const handleContextMenu = (event: React.MouseEvent) => {
    ...
    setContextMenu(
      contextMenu === null
        ...
        : // Repeated context menu actions when already open closes it in Chrome 84 on Ubuntu
          // Other native context menus may behave differently.
          // This behavior prevents the context menu from the backdrop from relocating existing context menus.
          null,
    );

    // Avoid losing text selection after opening the context menu on Safari and Firefox
