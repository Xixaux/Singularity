...
import { singularityDark } from '@singularity/colors';
...
/**
 * The defaultSettings object defines the default settings for the Singularity application.
 */
export const defaultSettings = {
	...
	theme: {
		main: defaultTheme,
		NavigationBarSlice: defaultTheme,
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the Singularity application.
 * It returns a SingularitySettingsConfigType object that can be used to configure the application.
 */
export function getParsedQuerySettings(): SingularitySettingsConfigType | object {
	...
	if (typeof defaultSettings === 'string') {
		...
		return JSON.parse(defaultSettings) as SingularitySettingsConfigType;
	}
...
export const defaultThemeOptions = {
    cssVariables: true,
    typography: {
        fontFamily: ['Inter', 'Roboto', 'Poppins', 'Arial', 'sans-serif'].join(','),
        fontWeightLight: 300,
