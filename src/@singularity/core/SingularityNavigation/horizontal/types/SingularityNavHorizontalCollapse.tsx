...
type SingularityNavHorizontalCollapseProps = SingularityNavItemComponentProps & {
	location: Location;
};

/**
 * SingularityNavHorizontalCollapse component helps rendering Horizontal Singularity Navigation Item with children
 * Used in SingularityNavVerticalItems and SingularityNavHorizontalItems
 */
function SingularityNavHorizontalCollapse(props: SingularityNavHorizontalCollapseProps) {
...
const NavHorizontalCollapseWithMemo = memo(SingularityNavHorizontalCollapse);
