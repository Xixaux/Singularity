...
type NavigationBarToggleFabProps = {
	className?: string;
	position?: string;
	onClick?: () => void;
};
...
/**
 * The NavigationBarToggleFab component.
 */
function NavigationBarToggleFab(props: NavigationBarToggleFabProps) {
...
export default NavigationBarToggleFab;
