...
import FeatureNavigationBox from '../../components/FeatureNavigationBox';
...
type NavigationBarMobileLayout2Props = {
	className?: string;
};

/**
 * The NavigationBarSlice mobile layout 2.
 */
function NavigationBarMobileLayout2(props: NavigationBarMobileLayout2Props) {
...
export default memo(NavigationBarMobileLayout2);
