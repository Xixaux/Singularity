...
// Method to retrieve the navigation item based on URL
function getNavigationItem(url: string, navigationItems: SingularityNavItemType[]): SingularityNavItemType {
