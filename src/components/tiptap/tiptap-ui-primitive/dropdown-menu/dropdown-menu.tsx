...
export const DropdownMenuItem = React.forwardRef<HTMLDivElement, DropdownMenuItemProps>(
	({ children, disabled, asChild = false, onSelect, className, ...props }, ref) => {
		...
		if (asChild && React.isValidElement(children)) {
			...
			// Generate merged props without directly adding onClick to the props object
			const mergedProps = {
				...itemProps,
				...(typeof children.props === 'object' ? children.props : {})
			};

			// Process onClick separately depending on the element type
			const eventHandlers = {
				onClick: (event: React.MouseEvent<HTMLElement>) => {
					// Convert the event to be compatible with handleSelect
